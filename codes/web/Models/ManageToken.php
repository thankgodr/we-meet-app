...
class ManageToken {
     ...
     */
    private $db_session_table = 't_user_sessions';

    /*
     * variable: db_session_table
     * Usage: Holds the table name for storing sessions
     */
    private $db_type_table = 't_dev_type';
    ...
    public function __construct($expiryHrs = 48, $enc_char_len = 20, $date_format = "Y-m-d H:i:s") {
    ...
    private function update_in_db($obj_id, $token, $mac_addr, $gmt_exp_date, $push_token) {
        ...
        $updateQry = "update t_user_sessions set token = '" . $token . "',expiry_gmt = '" . $gmt_exp_date . "',loggedIn = '1',push_token = '" . $push_token . "' where oid = " . $obj_id . " and device = '" . $mac_addr . "'";
