...
$(function () {
    ...
    (function() {
        if($("#chart-bar").length !== 0) {
            ...
            var chart  = new flotDemo("#chart-bar", "server/flot.php?type=bar"),
    ...
    (function() {
        if($("#chart-bar-stacked").length !== 0) {
            // Chart option/setting
            var chart  = new flotDemo("#chart-bar-stacked", "server/flot.php?type=barstacked"),
                option = {
                    series: {
                        stack: true,
                        bars: {
    ...
    (function() {
        if($("#chart-area").length !== 0) {
            // Chart option/setting
            var chart  = new flotDemo("#chart-area", "server/flot.php?type=area"),
                option = {
                    series: {
                        lines: {
                            show: true,
    ...
    (function() {
        if($("#chart-area-spline").length !== 0) {
            // Chart option/setting
            var chart  = new flotDemo("#chart-area-spline", "server/flot.php?type=areaspline"),
                option = {
                    series: {
                        lines: { show: false },
                        splines: {
    ...
    (function() {
        if($("#chart-line").length !== 0) {
            // Chart option/setting
            var chart  = new flotDemo("#chart-line", "server/flot.php?type=line"),
                option = {
                    series: {
                        lines: {
                            show: true,
    ...
    (function() {
        if($("#chart-line-spline").length !== 0) {
            // Chart option/setting
            var chart  = new flotDemo("#chart-line-spline", "server/flot.php?type=linespline"),
                option = {
                    series: {
                        lines: { show: false },
                        splines: {
    ...
    (function() {
        if($("#chart-pie1").length !== 0) {
            // Chart option/setting
            var chart  = new flotDemo("#chart-pie1", "server/flot.php?type=pie"),
                option = {
                    series: {
                        pie: { 
                            show: true,
    ...
    (function() {
        if($("#chart-pie2").length !== 0) {
            // Chart option/setting
            var chart  = new flotDemo("#chart-pie2", "server/flot.php?type=pie"),
                option = {
                    series: {
                        pie: { 
                            show: true,
