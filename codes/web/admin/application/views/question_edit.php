            ...
            <div class="container-fluid">
                ...
                <div class="page-header page-header-block">
                    <div class="page-header-section">
                        <h4 class="title semibold">Question Edit</h4>
                    </div>
                </div>
                <!-- Page Header -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-heading">
                                <h3 class="panel-title"><span class="panel-icon mr5"><i class="ico-table22"></i></span>Question Edit</h3>
                                <!-- panel toolbar -->
                            ...
                            <?php echo form_open('users/update_question');?>
 ...
 <td>
                                     $question->d_id        
                                            ...
                                            "<td>"."<textarea rows='4' cols='50' name='questionlist'>".$question->details_ques."</textarea>"."</td>
                                            ...
                                            <td class='text-center'>
                                                ...
                                                <div class='toolbar'>
                                                    <div class='btn-group'>
                                                        <button type='submit' value='$question->d_id' name='question'  class='btn btn-sm btn-danger'>Update</button>
