...
public class EditProfileNew extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try{
			relativeLayout=(RelativeLayout)findViewById(R.id.editetoplayout);
			relativeLayout.setBackgroundColor(MainActivity.navigation_color);
	...
	private void initData() {
		...
		btnSubmit.setBackgroundColor(MainActivity.navigation_color);
...
//			#updated 2015_0811:DS
			AlertDialog.Builder builder = new AlertDialog.Builder(this);
			builder.setTitle(R.string.delete_image_alert_title);
			builder.setMessage(R.string.delete_image_alert_title);
...
//# chnaged 2015_0811:DS
			Utility.showProcess(EditProfileNew.this, getString(R.string.updating_status));
				...
				public void run() {
					...
					if (string != null) {
						...
						Toast.makeText(EditProfileNew.this,
								R.string.status_update_failed, Toast.LENGTH_SHORT)
								.show();
					}
				}
			});
	...
	private void setprofile(int i) {
		...
		Utility.showProcess(EditProfileNew.this,getString(R.string.changing_image));
		final HttpRequest httpRequest = new HttpRequest();
		final List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();
		nameValuePairs.add(new KeyValuePair(Constant.KEY_FACEBOOK_ID,
				preferences.getString(Constant.FACEBOOK_ID, "")));
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == RESULT_OK) {
			...
			if (bitmap != null) {
				...
				Toast.makeText(this, R.string.error_accued, Toast.LENGTH_SHORT)
						.show();
				return;
			}
			switch (selectedImage) {
	...
	private void delete_picture(int image_id) {
		Utility.showProcess(EditProfileNew.this, getString(R.string.deleting_image));
		final HttpRequest httpRequest = new HttpRequest();
		final List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();
		nameValuePairs.add(new KeyValuePair(Constant.KEY_FACEBOOK_ID,
				preferences.getString(Constant.FACEBOOK_ID, "")));
	...
	private void uploadImage(final int id, String base64) {
		Utility.showProcess(EditProfileNew.this, getString(R.string.uploading_image));
		...
		final AlertDialog.Builder builder = new AlertDialog.Builder(this)
				.setAdapter(new ArrayAdapter<String>(this,
						android.R.layout.simple_list_item_1, new String[] {
								getString(R.string.camera), getString(R.string.gallery) }),
						new DialogInterface.OnClickListener() {
							@Override
