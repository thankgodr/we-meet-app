...
import com.epbitservices.unme.pojo.AgeRange;
import com.epbitservices.unme.pojo.Hometown;
import com.epbitservices.unme.pojo.ImageDetail;
import com.epbitservices.unme.pojo.Location;
import com.epbitservices.unme.pojo.LoginData;
import com.epbitservices.unme.pojo.PickUrl;
import com.epbitservices.unme.pojo.UploadImage;
import com.epbitservices.unme.pojo.UserFaceBookInfo;
import com.epbitservices.unme.pojo.UserFaceBookLikeData;
import com.epbitservices.unme.pojo.UserFacebookLikeId;
import com.epbitservices.unme.pojo.UserProfilePick;
...
import com.epbitservices.unme.utility.GellaryData;
import com.epbitservices.unme.utility.LocationFinder;
import com.epbitservices.unme.utility.LocationFinder.LocationResult;
...
public class LoginUsingFacebook extends FacebookActivity implements
	...
	SharedPreferences prefs,prefrences;
	Context context;
	...
	private class BackGroundTaskForFetchingDataFromFaceBook extends
		...
		protected void onPostExecute(Void result) {
			...
			if (flagForResponse) {
				...
				editor.putString("gender", mUserFaceBookInfo.getGender());
				editor.commit();
				...
				ErrorMessage(getString(R.string.alert),
						getString(R.string.facebook_profile_info_error_message));
			}
		}
		...
		protected void onPreExecute() {
			...
			try {
				...
				mdialog.setTitle(R.string.data_fetch_message);
	...
	private class BackGroundTaskForLogind extends AsyncTask<String, Void, Void> {
		...
		protected void onPreExecute() {
			if (mdialog != null) {
				mdialog.setTitle(R.string.creating_profile);
				mdialog.setMessage(getString(R.string.please_wait));
			}
			super.onPreExecute();
		}
					...
					if (mUploadImage.getErrNum() == 18) {
						...
						File imageFile = mUltilities.createFileInSideDirectory(
								...
								getResources()
										...
										+ "0.jpg");
						com.epbitservices.unme.utility.Utility
